        ...
        return ( 
            <div>
                <div className="tabledata row">
                            <div className="t-row d-flex col-12 col-sm-7 m-auto py-auto">
                                <select id="size" className="col-3 col-sm-4 col-md-auto ml-auto" onChange={()=>this.cambiasizepage("size")}>
                            ...
                            <div className="t-row d-flex col-12 col-sm-5 m-0 p-0">
                                <nav className="d-flex navbar-expand bg-light text-light m-auto">
